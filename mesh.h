...
public:
    ...
    Q_DECL_CONSTEXPR explicit Mesh(const My_Vector3D vecto,const Vertex verte_x
                                   ,const Vertex verte_y,const Vertex verte_z)
        :m_vector(vecto),m_1(verte_x),m_2(verte_y),m_3(verte_z){}

    const My_Vector3D& get_m_vector()const {return m_vector;}
